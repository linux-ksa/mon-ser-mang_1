<%@ page import="org.jivesoftware.openfire.plugin.CombinedPlugin" %>
...
<%  // Get parameters
    ...
    CombinedPlugin combinedPlugin = (CombinedPlugin) XMPPServer.getInstance().getPluginManager().getPlugin("Search");
    SearchPlugin plugin = combinedPlugin.getSearchPlugin();
